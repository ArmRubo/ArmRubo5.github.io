...
const name2 = document.querySelector('.info .notBar #notWin #nots .not .pupil .name2');
const name3 = document.querySelector('.info .notBar #notWin #nots .not .pupil .name3');
...
const clear1 = document.querySelector('.info .notBar #notWin #nots .not1 .letter .close1');
...
const check = () => {
    if (not.innerHTML == '' && not1.innerHTML == '') {
        nots.innerHTML = '';
...
const date = a.getDate() + '/' + month1() + '/' + a.getFullYear();
...
translate2.addEventListener('click', function () {
    letterEng1.classList.toggle('active');
    letterArm1.classList.toggle('active');
    translate2.classList.toggle('active');
    translate3.classList.toggle('active');
    name2.classList.toggle('active');
    name3.classList.toggle('active');
    clear1.classList.toggle('active');
})
